...
@InputType()
class ProjectUserCreateNestedManyWithoutProjectsInput {
...
export { ProjectUserCreateNestedManyWithoutProjectsInput as ProjectUserCreateNestedManyWithoutProjectsInput };
